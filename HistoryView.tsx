  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <button 
          onClick={onClear}
          className="text-red-500 text-xs flex items-center gap-1 hover:bg-red-50 px-2 py-1 rounded-lg transition-colors"
        >
          <Trash2 size={14} />
          پاک کردن
        </button>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-500">
                {new Date(item.timestamp).toLocaleDateString('fa-IR')} · امتیاز {item.qualityScore}
              </p>
            </div>
